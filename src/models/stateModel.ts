...
async function initializeStates() {
  ...
  var population_api = "https://api.census.gov/data/2021/acs/acs1/profile?get=NAME,DP05_0001E&for=state:*";
  var docs: any = await fetch(population_api).then(result => result.json());
